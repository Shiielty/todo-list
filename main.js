...
content.addEventListener("change", (e) => {
    if (e.target.type == "checkbox") {
        if (e.target.checked) {
            ...
            console.log((0,_handler__WEBPACK_IMPORTED_MODULE_2__.whichActive)(_handler__WEBPACK_IMPORTED_MODULE_2__.projects).tasks)
        } else {
