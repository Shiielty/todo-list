...
content.addEventListener("click", (e) => {
    ...
    if (e.target.className === "add-task") {
        insertAfter((0,_dom__WEBPACK_IMPORTED_MODULE_1__.createForm)("", "", "normal", ""), e.originalTarget.parentNode);
